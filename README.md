...
Each project and experience entry on the Projects and Experiences is driven by structured data files, making it easy to add new content without touching the component logic. The site is deployed on Vercel with automatic redeployment on every push to the main branch. The Contact Me page uses EmailJS for template formatting and form-based emailing.
